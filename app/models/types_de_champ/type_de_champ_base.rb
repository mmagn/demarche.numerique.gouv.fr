...
class TypesDeChamp::TypeDeChampBase
  ...
  delegate :description, :libelle, :mandatory, :mandatory?, :stable_id, :fillable?, :public?, :type_champ, :options_for_select, :drop_down_options, :drop_down_other?, :drop_down_advanced?, :referentiel, :RIB?, :justificatif_domicile?, :titre_identite_nature?, to: :@type_de_champ
