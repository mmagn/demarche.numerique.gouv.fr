# -*- encoding: utf-8 -*-
# stub: flipper-active_support_cache_store 1.3.6 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://www.flippercloud.io/docs/optimization#activesupportcachestore".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "3.6.9".freeze
  s.summary = "ActiveSupport::Cache feature flag cache adapter for Flipper".freeze

  s.installed_by_version = "3.6.9".freeze

  s.specification_version = 4

  s.add_runtime_dependency(%q<flipper>.freeze, ["~> 1.3.6".freeze])
  s.add_runtime_dependency(%q<activesupport>.freeze, [">= 4.2".freeze, "< 9".freeze])
end
